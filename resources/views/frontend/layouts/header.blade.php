...
<header>
                                                ...
                                                <li class="menu-item-has-children">
                                                    ...
                                                    <ul class="sub-menu">
                                                        @foreach (App\Enums\ThemeList::cases() as $theme)
                                                            <li class=""><a href="{{ route('change-theme', $theme->value) }}" title="">{{ __($theme->value) }}</a></li>
                                                        @endforeach
                                                    </ul><!-- /.sub-menu -->
                                                </li>
                                            @else
    ...
    <form action="{{ route('search_teachers') }}" class="tgmenu__search-form">
        <div class="select-grp">
            ...
            {{-- Category filter placeholder, commented out for future use --}}
        ...
        <div class="input-grp">
            <input type="text" placeholder="{{ __('Search For Teachers') }} . . ." name="search" value="{{ request('search') }}">
                                ...
                                <ul class="list-wrap">
                                    ...
                                    <li class="mini-cart-icon user_icon">
                                        ...
                                        <ul class="menu_user_list">
                                            @auth('admin')
                                                <li><a href="{{ route('admin.dashboard') }}">{{ __('Admin Dashboard') }}</a>
                                                </li>
                                            @endauth
                                            @guest
