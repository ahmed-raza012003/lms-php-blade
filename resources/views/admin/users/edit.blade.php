                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control" placeholder="{{ __('Leave blank to keep unchanged') }}">
                                @error('password')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="role" class="form-control" required>
                                    ...
                                    <option value="parent" {{ old('role', $user->role) == 'parent' ? 'selected' : '' }}>{{ __('Parent') }}</option>
