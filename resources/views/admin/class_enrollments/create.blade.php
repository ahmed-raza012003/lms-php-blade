...
@section('title')
    <title>{{ __('Create Class Enrollment') }}</title>
@endsection
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>{{ __('Create Class Enrollment') }}</h1>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.class-enrollments.store') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                ...
                                <select name="class_id" class="form-control" required>
                                    ...
                                    @foreach ($classes as $class)
                                        <option value="{{ $class->class_id }}" {{ old('class_id') == $class->class_id ? 'selected' : '' }}>{{ $class->subject }}</option>
                                    @endforeach
                                </select>
                                @error('class_id')
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="enrollment_date" class="form-control" value="{{ old('enrollment_date') }}" required>
